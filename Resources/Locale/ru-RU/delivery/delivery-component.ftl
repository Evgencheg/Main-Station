...
delivery-priority-inactive-examine = [color=#886600]Жёлтая лента приоритета[/color] на замке защиты от вскрытия неактивна.
...
delivery-penalty = С БАНКОВСКОГО СЧЁТА СНАБЖЕНИЯ СПИСАН ШТРАФ В РАЗМЕРЕ { $credits } КРЕДИТОВ.
