...
ent-CrateSecurityRiot = ящик для подавления беспорядков
    .desc = Содержит два комплекта противоударной брони, шлемы, щиты и пистолеты-подавители, заряженные травматическими патронами. Дополнительные боеприпасы включены. Для открытия требуется доступ службы безопасности.
ent-CrateSecurityHeavyBallisticArmor = ящик баллистической брони
    .desc = Содержит два комплекта тяжёлой баллистической брони, шлемы, щиты и противогазы. Для открытия требуется доступ службы безопасности.
ent-CrateSecurityHeavyAblativeArmor = ящик лазерно-аблятивной брони
    .desc = Содержит два комплекта тяжёлой лазерно-аблятивной брони, шлемы, щиты и противогазы. Для открытия требуется доступ службы безопасности.
ent-CrateSecurityHeavySecurityArmor = ящик тяжёлой охранной брони
    .desc = Содержит два комплекта тяжёлой охранной брони, шлемы и противогазы. Для открытия требуется доступ службы безопасности.
ent-CrateSecuritySwat = ящик спецназа
    .desc = Содержит два полноценных комплекта экипировки SWAT. Для открытия требуется доступ службы безопасности.
