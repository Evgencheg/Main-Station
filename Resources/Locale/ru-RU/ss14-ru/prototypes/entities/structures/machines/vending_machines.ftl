...
ent-VendingMachineFitness = SweatMAX
    .desc = Поставщик средств для тренировок и пищевых добавок, который наживается на вашей неадекватности.
ent-VendingMachineHotfood = горячая еда
    .desc = Старый торговый автомат, обещающий «горячую еду». Вы сомневаетесь, что какое-либо его содержимое все еще съедобно.
ent-VendingMachineSolsnack = Марс Март
    .desc = Торговый автомат SolCentric, раздающий угощения из дома.
ent-VendingMachineWeeb = Ниппон-Тан
    .desc = Удручающе этнический торговый автомат, загруженный низкокалорийными закусками с высоким содержанием сахарозы.
