...
ent-ComputerShuttleSyndieDropPod = консоль десантной капсулы синдиката
    .desc = Используется для запуска десантной капсулы. Это поездка в один конец, не забудьте взять с собой обед.
...
ent-ComputerPsionicsRecords = консоль реестра псиоников
    .desc = Это можно использовать для проверки записей реестра псиоников. Только эпистемика может их изменить.
...
ent-ComputerCargoShuttle = консоль грузового шаттла
