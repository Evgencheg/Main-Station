...
ent-RollingOfficeChairBase = стул
    .desc = Перебегайте от стола к столу, потому что стажерам приходится стоять.
ent-StoolBase = стул
...
ent-ChairOfficeLightRolling = белый офисный стул
    .suffix = НЕ МАППИТЬ
    .desc = { ent-RollingOfficeChairBase.desc }
ent-ChairOfficeDarkRolling = темный офисный стул
    .suffix = НЕ МАППИТЬ
