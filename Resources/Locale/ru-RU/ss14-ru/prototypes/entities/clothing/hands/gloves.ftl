...
ent-ClothingHandsGlovesFingerlessWhite = перчатки без пальцев
    .desc = Обычные перчатки без кончиков пальцев.
...
ent-ClothingHandsGlovesEvening = вечерние перчатки
    .desc = Перчатки длиной выше локтя. Подаём элегантность и подаем внешний вид!
ent-ClothingHandsTacticalMaidGlovesLoadout = тактические перчатки горничной
    .desc = Тактические перчатки горничной. Каждая уважающая себя горничная должна уметь незаметно удалить пятна, оставленные пассажирами.
