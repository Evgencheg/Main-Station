...
ent-ClothingNeckOldMantle = старая мантия
    .desc = Рваная тканевая накидка, выцветшая с годами. Слабо пахнет сигарами.
ent-ClothingNeckUnathiMantle = мантия унатхов
    .desc = Довольно жуткая подборка обработанных шкур и кожи, сшитых вместе, чтобы сформировать рваную мантию.
