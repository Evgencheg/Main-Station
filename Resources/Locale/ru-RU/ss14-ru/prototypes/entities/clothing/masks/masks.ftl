...
ent-ClothingMaskGasCaptainCombat = капитанский боевой противогаз
    .desc = Противогаз военного образца, подключаемый к источнику воздуха, окрашенный и снабженный эмблемой, соответствующей владельцу. Выдается только лучшим специалистам станции.
...
ent-ClothingMaskNeckGaiterWhite = шейные гетры
