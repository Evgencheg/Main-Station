...
ent-ActionBecomeValid = Стать действительным
    .desc = *замечает ваш знак смерти* ой, что это.
...
ent-ClothingHeadHatHeadBandBasic = базовая повязка на голову
    .desc = Идеально подходит для мастеров боевых искусств, потных мошенников и туннельных гангстеров.
