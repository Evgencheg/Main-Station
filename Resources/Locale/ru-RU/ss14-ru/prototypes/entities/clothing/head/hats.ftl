...
ent-ClothingHeadHatBeretWhite = берет
...
ent-ClothingHeadHatBeretArtist = берет художника
    .desc = Берет для художника.
ent-ClothingHeadHatBeretPeaked = остроконечный берет
    .desc = Остроконечный берет.
...
ent-ClothingHeadHatChefNt = поварской колпак nt
    .desc = { ent-ClothingHeadHatChef.desc }
ent-ClothingHeadHatChefIdris = поварской колпак idris
    .desc = { ent-ClothingHeadHatChef.desc }
ent-ClothingHeadHatChefOrion = поварской колпак orion express
    .desc = { ent-ClothingHeadHatChef.desc }
...
ent-ClothingHeadHatPirateTricorn = пиратская шляпа
    .desc = Йо-хо-хо и бутылка рома!
...
ent-ClothingHeadHatCowboyRed = красная ковбойская шляпа
    .desc = { ent-ClothingHeadHatCowboyBrown.desc }
ent-ClothingHeadHatFlatcapBartenderNanotrasen = плоская кепка бармена nt
    .desc = { ent-ClothingHeadBase.desc }
ent-ClothingHeadHatFlatcapBartenderIdris = плоская кепка бармена idris
    .desc = { ent-ClothingHeadBase.desc }
ent-ClothingHeadHatFlatcapBartenderOrion = плоская кепка бармена orion express
    .desc = { ent-ClothingHeadBase.desc }
ent-ClothingHeadHatBeanie = шапочка
    .desc = Облегающая зимняя шапка без полей. Этот плотный.
ent-ClothingHeadHatBeanieWinter = зимняя шапка
    .desc = Облегающая зимняя шапка без полей. У этого есть клапаны, которые закрывают уши.
ent-ClothingHeadHatBeanieSubmariner = шапка подводника
    .desc = Модель плотно облегающей шапки, популярная среди работников подводных станций.
ent-ClothingHeadHatBeanieTight = плотная шапочка
    .desc = Довольно плотная шапка, скрывающая волосы.
ent-ClothingHeadHatSlouch = шляпа с напуском
    .desc = Широкополая шляпа, сложенная так, что образует напуск.
ent-ClothingHeadHatSunVisor = солнцезащитный козырек
    .desc = Стильный козырек, предназначенный для защиты от яркого солнечного света.
ent-ClothingHeadHatBeanieGreen = зеленая шапочка
    .desc = Темно-зеленая шапочка.
ent-ClothingHeadHatMountie = шляпа монтера
    .desc = Плоская шапка изготовлена Старший Инженериз 100% мехового фетра.
