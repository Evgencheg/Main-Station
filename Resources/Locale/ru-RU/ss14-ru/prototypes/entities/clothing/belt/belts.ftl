...
ent-ClothingBeltGeneric = пояс
    .desc = Простой ремень из кожи.
ent-ClothingBeltGenericThin = тонкий ремень
    .desc = Этот ремень тоньше обычного.
ent-ClothingBeltGenericThick = толстый ремень
    .desc = Смелое модное заявление.
ent-ClothingBeltWaist = поясной ремень
    .desc = Пояс на талии, придающий образу более приталенный силуэт.
ent-ClothingBeltWaistThin = тонкий поясной ремень
    .desc = Чтобы подчеркнуть приподнятую талию.
