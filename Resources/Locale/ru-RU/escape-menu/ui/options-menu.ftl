...
ui-options-chatstack-0 = Выкл
ui-options-chatstack-1 = Только последнее сообщение
ui-options-chatstack-2 = Последние 2 сообщения
ui-options-chatstack-3 = Последние 3 сообщения
...
ui-options-announcer-disable-multiple-sounds-tooltip = Некоторые объявления будут звучать некорректно
...
ui-options-no-filters = Выключить фильтры рас
...
ui-options-hud-layout-overlay = Стандартный
...
ui-options-function-target-left-foot = Нацелиться на левую пятку
ui-options-function-target-right-foot = Нацелиться на правую пятку
...
ui-options-function-auto-get-up = Автоматически вставать
