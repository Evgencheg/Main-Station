...
# Пример: "1 из 3 агентов Синдиката был арестован"
objectives-round-end-result-in-custody = { $custody } из { $count } { $agent } были арестованы.
objectives-player-user-named = [color=White]{ $name }[/color] ([color=gray]{ $user }[/color])
objectives-player-named = [color=White]{ $name }[/color]
objectives-no-objectives = { $custody }{ $title } - это был { $agent } без особых целей.
objectives-with-objectives = { $custody }{ $title } - это был { $agent } со следующими целями:
