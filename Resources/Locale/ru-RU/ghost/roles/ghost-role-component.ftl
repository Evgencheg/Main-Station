...
ghost-role-information-rules-team-antagonist =
    ...
    Вам разрешено помнить знания об игре в целом, например, как готовить, как использовать предметы и т.д.
    Вам [color=red]НЕ[/color] разрешается помнить или говорить имя, внешность и т.д. вашего предыдущего персонажа.
ghost-role-information-familiar-name = Псионный фамильяр
ghost-role-information-familiar-description = Межпространственное существо, привязанное к воле Псионика.
...
ghost-role-information-squackroach-name = Сквак-таракан
ghost-role-information-squackroach-description = Дьявольский, но почти безобидный сквак-таракан.
...
ghost-role-information-space-goldfish-description = Бесцельно плавайте в воздухе и покусывайте любого, кто будет достаточно глуп, чтобы навлечь на себя ваш гнев.
...
ghost-role-information-minebot-description = Помогайте шахтёрам в их нелёгком деле.
...
ghost-role-information-ifrit-rules = Огненный дух родом из Геенны, призванный научным руководителем. Следуйте за ним и не создавайте проблем, пока он не прикажет обратное.
ghost-role-information-ifrit-wizard-name = Ифрит (Призыв мага)
ghost-role-information-ifrit-wizard-description = Слушайтесь своего хозяина. Не принимайте весь урон на себя. Бейте людей со всей силы.
