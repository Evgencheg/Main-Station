...
reagent-name-soulbreaker-toxin = токсин «соулбрейкер»
reagent-desc-soulbreaker-toxin = Анти-псионический препарат, примерно в 4 раза более мощный, чем майндбрейкер.
reagent-name-lotophagoi-oil = масло лотофагов
reagent-desc-lotophagoi-oil = Сверхмощный препарат, который гораздо эффективнее обычных галлюциногенов пробуждает псионические способности, но имеет более тяжёлые побочные эффекты.
reagent-name-ectoplasm = эктоплазма
reagent-desc-ectoplasm = Физический компонент полуматериальных духов.
reagent-name-ousiana-dust = пыль узианы
reagent-desc-ousiana-dust = От этого порошка исходит эхо беззвучного крика; это кувалда для разума, способная жестоко проломить любые псионические блоки, но за определённую цену.
reagent-name-formic-acid = муравьиная кислота
reagent-desc-formic-acid = Коррозийное химическое вещество, используемое в производстве ферментов.
