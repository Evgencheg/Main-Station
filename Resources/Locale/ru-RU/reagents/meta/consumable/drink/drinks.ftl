...
reagent-desc-the-martinez = Легенда Найт-Сити. В памяти - как напиток, в беспамятстве - как очередной пьяница.
reagent-name-white-gilgamesh = белый гильгамеш
reagent-desc-white-gilgamesh = Тошнотворная смесь молока и пива. Заставляет почувствовать себя так, будто вы сделаны из дерева.
